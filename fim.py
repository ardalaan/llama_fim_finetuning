...
def get_fim_token_ids(tokenizer):
    if "codellama" in tokenizer.name_or_path:
        ...
        return (
            tokenizer.bos_token_id,
            tokenizer.encode("<|reserved_special_token_245|>")[1],
            tokenizer.encode("<|reserved_special_token_246|>")[1],
            tokenizer.encode("<|reserved_special_token_247|>")[1],
            tokenizer.encode("<|finetune_right_pad_id|>")[1],
        )
